...
const createBorrower = async (req, res) => {
  try {
    ...
    const newBorrower = await borrowerService.createBorrower({ name, email, phoneNumber });
...
const updateBorrower = async (req, res) => {
  try {
    ...
    const { name, email, phoneNumber } = req.body;
    const updatedBorrower = await borrowerService.updateBorrower(borrowerId, { name, email, phoneNumber });
